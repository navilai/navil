            ...
            "skills": [
                {
                    ...
                    "installs": 12453,
                    "rating": 4.7,
                    "description": "GitHub integration for code review, PR management, and issue tracking",
    ...
    "update_skill": {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "force": {
                    "type": "boolean",
                    "description": "Force update even if breaking changes detected (default: false)",
                },
                "backup": {
                    "type": "boolean",

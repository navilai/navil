...
export const PLANS: PlanInfo[] = [
  {
    ...
    agents: '25',
    requests: '60 req/min',
    features: ['Auto-shares anonymized threat data', '48h-delayed threat patterns', 'Community support'],
  },
  {
    name: 'Pro',
    tier: 'pro',
    ...
    features: ['Real-time threat feed', 'CI/CD SARIF integration', 'Webhooks (Slack/Discord)'],
  },
  {
    name: 'Growth',
    tier: 'growth',
    price: '$129/mo',
    annualPrice: '$1,290/yr',
    agents: '100',
    requests: '5,000 req/min',
    features: ['Everything in Pro', 'Basic OIDC identity', '5 custom threat rules', 'Email support (48h SLA)'],
    highlighted: true,
  },
  {
    name: 'Team',
    ...
    features: ['Full OIDC & delegation chains', 'Unlimited custom rules', 'Fleet-wide analytics', 'Priority support (8h SLA)'],
  },
  {
    name: 'Enterprise',
    tier: 'enterprise',
    ...
    features: ['Everything in Team', 'SLA guarantees', 'On-prem proxy deployment', 'SSO integration'],
  },
]
